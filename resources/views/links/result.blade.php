...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Encurtador de Url') }}</title>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ env("APP_URL").":8000/".$slug }}" class="underline text-gray-900 dark:text-white">{{ env("APP_URL").":8000/".$slug }}</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Seu link encurtado foi criado com sucesso!!
                                </div>
                            </div>
                        </div>
                    </div>
